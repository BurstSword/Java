...
public class Datos {
    private static Nota[] arrayN = {new Libro("Un monstruo viene a verme"), new Libro("La casa torcida"),
    ...
    public static ArrayList<Libro> listaLibros = new ArrayList<>(Arrays.asList(arrayN));
